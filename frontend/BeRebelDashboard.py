...
def berebel_dashboard(input_df):
    ...
    df_aggregated = static_dataframe.groupby('date_estratto_conto', as_index=False).agg({'km_percorsi': 'sum'})
    ...
    df_aggregated = static_dataframe.groupby('date_estratto_conto', as_index=False).agg({'totale_pagato': 'sum'})
    ...
    dynamic_dataframe['year'] = dynamic_dataframe['date_estratto_conto'].dt.to_period('Y').astype(str)
    df_category_expenses = dynamic_dataframe.groupby('year', as_index=False).agg({'km_percorsi': 'sum'})
    ...
    dynamic_dataframe['year'] = dynamic_dataframe['date_estratto_conto'].dt.to_period('Y').astype(str)
    df_category_expenses = dynamic_dataframe.groupby('year', as_index=False).agg({'totale_pagato': 'sum'})
